...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="css/8_per_page.css" />
                ...
                <xsl:for-each select="rss/channel/item">
                    <xsl:if test="position() mod 2 = 1">
                        <xsl:variable name="tr_open">
                            <xsl:if test="position() mod 8 = 1">&lt;tr class=&quot;page-start&quot;&gt;</xsl:if>
                            <xsl:if test="position() mod 8 = 7">&lt;tr class=&quot;page-end&quot;&gt;</xsl:if>
                            <xsl:if test="position() mod 8 != 1 and position() != 7">&lt;tr&gt;</xsl:if>
                        </xsl:variable>
